...
# ╔═╡ dfb52e60-c6d9-11ee-0df1-7dc0b7e74acb
using Sockets, OpenSoundControl, PlutoUI

# ╔═╡ 66531a9c-97e7-4025-9ccf-5b71241e6aac
begin
sock2 = UDPSocket()
bind(sock2, ip"127.0.0.1", 7777)
end

# ╔═╡ 5ed01326-1a51-4d09-aaa1-57e15aa8ea98
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 1c1c96e2-8d0e-41a7-bcb7-cca2244e91c7
flag = false

# ╔═╡ 18197c27-4c26-447f-9964-59574b296834
while flag
	try
		msg2 = OscMsg(recv(sock2))
		#show(msg2)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "3a2025ac78c681b341db64eb0c94964962388009"
